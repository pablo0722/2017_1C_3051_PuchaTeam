...
namespace TGC.Group.Model
{
    ...
    /// </summary>
    class MyCamara1Persona : TgcCamera
    {
        ...
        public MyCamara1Persona(TgcD3dInput input)
        {
            Input = input;
        ...
        public MyCamara1Persona(Vector3 positionEye, TgcD3dInput input) : this(input)
        {
            this.positionEye = positionEye;
        }

        public MyCamara1Persona(Vector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        public MyCamara1Persona(Vector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed,
            TgcD3dInput input)
            : this(positionEye, moveSpeed, jumpSpeed, input)
        {
            RotationSpeed = rotationSpeed;
            base.SetCamera(new Vector3(0, 0, 100), new Vector3(0, 0, 0), new Vector3(0, 1, 0));
        }
