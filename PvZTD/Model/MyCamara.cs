...
namespace TGC.Group.Model
{
    ...
    /// </summary>
    public class MyCamara : TgcCamera
    {
        ...
        public MyCamara(Vector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public MyCamara(Vector3 target, Vector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
