...
namespace TGC.Group.Model
{
    ...
    /// </summary>
    public class MyCamara3Persona : TgcCamera
    {
        ...
        /// </summary>
        public MyCamara3Persona()
        {
            resetValues();
        }

        public MyCamara3Persona(Vector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public MyCamara3Persona(Vector3 target, Vector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
